...
className={`w-image c13rvnfs c12e0v0g c1eswi8f`} />
<MarkdownEmbed
code={"\nOnce a model is selected, you can enter a message. Type the text you want to send to the AI model and click or tap the Send button.\\\nTo insert a line break on macOS, press `⇧ (Shift)` + `↩︎ (Return)` simultaneously.\n\nYou can also attach files to your message by clicking or tapping the attach button in the message input area, or by dragging and dropping files:\n- **Image Files**\n  - Allows models with image recognition capabilities to recognize images.\n- **Text Files**\n  - You can attach various text files, including `.txt` and `.md`, to all models that support chat.\n- **PDF Files**\n  - You can attach PDF files to all models that support chat. Furthermore, for models with vision (image recognition) capabilities, each page is also sent as an image, allowing them to recognize diagrams and layouts in addition to text.\n"}
className={`w-markdown-embed c1jwyh4u c71q0nn cznj3ay c1suh244 c1ggxnc2 c1wu3i9x cnx8vu2 cewqdn7 cid3iks c1sggce9 csbw7ja ci7c9m9 c1g2fr61 cxt8a1l cwnj7qc clqnjme c1etwcna cbnpkwc c1nlknvl cfdvko0 c90px2c c1ka6s8k cwjk396 cbje6ix c7retf c1wqf82o cuuxbau c14a81n5 cgwrgp8 c1r61068 c1rnewgl cvrkuwl ckdvx6o c1754bfq c1exg9jr c1tzwmwe`}>
</MarkdownEmbed>
<Image
