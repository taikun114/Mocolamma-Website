...
<Image
src={imagePath + "/Mocolamma_Banner-ja.webp?raw=true"}
loading={"eager"}
fetchPriority={"high"}
className={`w-image c1a2244i c1eswi8f`} />
<MarkdownEmbed
code={"Mocolammaのドキュメントへようこそ！\\\nMocolammaの使い方から細かい設定まで、Mocolammaに関する情報がまとめられています。\n\n- [**ニュース**](/jp/docs/news)\n- [**サーバータブ**](/jp/docs/server-tab)\n- [**モデルタブ**](/jp/docs/model-tab)\n- [**チャットタブ**](/jp/docs/chat-tab)\n- [**画像生成タブ**](/jp/docs/image-generation-tab)\n- [**設定**](/jp/docs/settings)\n- [**App Storeレビューリクエストについて**](/jp/docs/app-store-review-requests)"}
