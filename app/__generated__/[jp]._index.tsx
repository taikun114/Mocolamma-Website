...
className={`w-element ck0qs61`}>
<MarkdownEmbed
code={"![GitHub Downloads (all assets, all releases)](https://img.shields.io/github/downloads/taikun114/Mocolamma/total?style=for-the-badge&label=無料DL&labelColor=6e8895&color=192023)"}
...
className={`w-element ck0qs61`}>
<Image
src={"/assets/GitHub_Badge-ja_2x_xyAUXQ8pM2UXM5A4ANyor.webp"}
width={1040}
height={320}
...
<p
className={`w-element c11wsiwx c1su7aph`}>
{"ネットワーク上のOllamaサーバーと接続して、複数のOllamaサーバーを簡単に管理できます。"}
</p>
</div>
</Link>
<Link
...
<p
className={`w-element c11wsiwx c1su7aph`}>
{"接続したOllamaサーバー上の大規模言語モデル（LLM）を簡単に管理できます。"}
</p>
</div>
</Link>
<Link
...
<p
className={`w-element c11wsiwx c1su7aph`}>
{"簡易チャット機能で、接続したサーバー上のモデルをテストすることができます。"}
</p>
</div>
</Link>
</div>
...
<Image
loading={"lazy"}
src={"/assets/Server-Tab-HP-ja_S7rCLZL0gCxvEQwceikZs.webp"}
width={1920}
height={1080}
alt={""}
...
{"複数のOllamaサーバーをアプリに追加して、簡単に切り替えることができます。それぞれのサーバーにお好みの名前をつけることで、簡単に識別しやすく管理することができます。"}
</p>
</div>
</div>
<div
...
<Image
loading={"lazy"}
src={"/assets/Model-Tab-HP-ja_xRH2FlnaaSjpJrScWld_Q.webp"}
width={1920}
height={1080}
alt={""}
className={`w-image c13rvnfs`} />
<p
className={`w-element c11wsiwx c1su7aph c1y9f2xs c10ieuse`}>
{"接続したOllamaサーバー上にあるモデル情報を確認したり、モデルの追加や削除を行うことができます。モデルリストは様々な順番で並べ替えることができるため、容量の大きい順に並べ替えて、使っていない大きなモデルを探して削除するといった場合に便利です。"}
</p>
</div>
</div>
<div
...
<Image
loading={"lazy"}
src={"/assets/Chat-Tab-HP-ja_AT5fUJ_6UxIW_nVaIhsqT.webp"}
width={1920}
height={1080}
alt={""}
className={`w-image c13rvnfs`} />
...
<p
className={`w-element c11wsiwx c1su7aph c1y9f2xs c1ak9s8m`}>
{"Mocolammaを使ってみてとても便利だと感じていただけましたら、開発者をサポートしていただけますと嬉しいです。開発を続けるモチベーションになります！"}
{""}
<br />
{""}
...
className={`w-element ck0qs61`}>
<MarkdownEmbed
code={"![GitHub Latest Release](https://img.shields.io/github/v/release/taikun114/Mocolamma?sort=semver&display_name=tag&style=for-the-badge&label=リリース&labelColor=ffffff&color=000000)"}
className={`w-markdown-embed c1411o3y c1igc709 ctsxlvw cjdjvq6 c1wlos4g c1klrugo c1kb16ip c91o05s`}>
</MarkdownEmbed>
</Link>
<Link
...
className={`w-element ck0qs61`}>
<MarkdownEmbed
code={"![GitHub Repo stars](https://img.shields.io/github/stars/taikun114/Mocolamma?style=for-the-badge&label=スター&labelColor=ffffff&color=000000)"}
className={`w-markdown-embed c1411o3y c1igc709 ctsxlvw cjdjvq6 c1wlos4g c1klrugo c1kb16ip c91o05s`}>
</MarkdownEmbed>
</Link>
<Link
...
className={`w-element ck0qs61`}>
<MarkdownEmbed
code={"![GitHub Downloads (all assets, all releases)](https://img.shields.io/github/downloads/taikun114/Mocolamma/total?style=for-the-badge&label=無料ダウンロード数&labelColor=ffffff&color=000000)"}
className={`w-markdown-embed c1igc709 c1411o3y ctsxlvw cjdjvq6 c1wlos4g c1klrugo c1kb16ip c91o05s`}>
</MarkdownEmbed>
</Link>
</div>
