...
import { Image as Image, Button as Button, Text as Text, Box as Box, HtmlEmbed as HtmlEmbed, Paragraph as Paragraph, Fragment as Fragment_1, MarkdownEmbed as MarkdownEmbed, Slot as Slot } from "@webstudio-is/sdk-components-react/components";
...
<Image
src={imagePath + "/Image-Generation-Tab-ja-1.webp?raw=true"}
loading={"lazy"}
alt={"画像生成タブ"}
...
<Image
src={imagePath + "/Image-Generation-Tab-ja-2.webp?raw=true"}
loading={"lazy"}
alt={"モデルを選択"}
className={`w-image c13rvnfs c12e0v0g c1eswi8f`} />
<MarkdownEmbed
...
<Image
src={imagePath + "/Image-Generation-Tab-ja-3.webp?raw=true"}
loading={"lazy"}
alt={"プロンプトを入力"}
className={`w-image c13rvnfs c12e0v0g c1eswi8f`} />
<MarkdownEmbed
